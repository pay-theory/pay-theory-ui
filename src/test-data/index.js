...
const accounts = [{
        ...
        given_name: 'Aron',
        family_name: 'Price',
        picture: 'https://s.gravatar.com/avatar/b5ecfaecf2ebe416c3cf61eb6fb9abc8?s=480&r=pg&d=https%3A%2F%2Fcdn.auth0.com%2Favatars%2Far.png',
...
const paymentItem = {
    ...
    item_start_date: '',
    item_end_date: '',
    item_description: 'We have a serious bat infestation in the cafeteria, they are covering nearly the entire ceiling and it is really starting to make some of the children unsettle. Please donate today to help us get rid of these bats.',
...
const paymentItems = [{
    ...
    },
    {
        ...
        data: {
            ...
            item_publication_key: 'ea389359-4dbd-5d9e-b182-8ce8bb74e36a-1564413126808',
        ...
        },
        {
            ...
            data: {
                transaction_history: [{
                        ...
                        currency_code: 'USD',
                        client_id: 1128,
                        client_transaction_id: '3dbf1946-d9a4-5d9b-b6a1-e5146e351c62'
                    },
                    {
                        success: false,
                        approved: false,
                        ...
                        response_code: null,
                        id: null,
                        charge_transaction_id: '00000000-0000-0000-0000-000000000000',
        ...
        },
        {
            ...
            data: {
                ...
                transaction_history: [{
                    ...
                    client_id: 1128,
                    currency_code: 'USD',
                    client_transaction_id: '30b5736f-72e3-59d4-9ab9-32a655d5d5a6',
                    approved: true,
                    recurring: false,
                    amount: 2300,
                    response_code: '00'
...
const invoiceItems = [{
    ...
    data: {
        ...
        item_start_date: '',
        item_end_date: '',
        item_publication_key: '1e2805cd-dd03-50a8-9ae7-4a444b0d11ff-1565192967161',
        item_description: '',
        item_has_quick_pay_options: true,
...
const partners = [{
        ...
        data: {
            ...
            partner_apikey: '$2b$10$vijvgmC/7BAA12iA68DIkegEduFHNO3JatqIRG0DIV3/gvaoCWwji',
...
const nativeCredentials = {
    ios: {
        'com.paytheory.app': 'paytheory',
        'com.test.app': 'Test'
    },
    android: {
        'paytheory': {
            productionDigest: 'com.paytheory.app',
            debugDigest: 'com.paytheory.app'
        },
        'Test': {
            productionDigest: 'com.test.app',
            debugDigest: 'com.paytheory.app'
        }
    }
}

export { settlement, feeModes, nativeCredentials }
