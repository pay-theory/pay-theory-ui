...
const InnerTable = ({
  ...
  const updateWidth = (key, width) => {
    ...
    let totalWidth = Object.values(columnWidth).reduce(reduceWidth, 0);
  ...
  return (
    <TableContext.Provider
      value={{ selected, setSelected, id, updateWidth, parentWidth, rowWidth }}
    >
      <div id={id} className="table-wrapper" ref={wrapper}>
        ...
        <div className="inner-table-wrapper">
          <table
            ...
            style={{
              width:
                rowWidth > parentWidth ? `${rowWidth}px` : `${parentWidth}px`
            }}
          >
