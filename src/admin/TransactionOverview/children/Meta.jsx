    ...
    return (
        <BooksHooks.context.payment.Consumer>
            {(paymentHook) => {
                ...
                const currentState = paymentHook.transaction_history
                    .slice(0)
                    .pop()
                ...
                const buildBilling = () => {
                    return (
                        <span>
                            ...
                            <br />
                            {paymentHook.payor.payor_street},{' '}
                            {paymentHook.payor.payor_city},{' '}
                            {paymentHook.payor.payor_state}{' '}
                            {paymentHook.payor.payor_zip_code}
                        </span>
                    )
                }
                return (
