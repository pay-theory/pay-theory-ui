						...
						<div className='tab-content' data-testid='DistrictInfoTab'>
							...
							<div id='country-timezone' className='tab-row'>
								...
								<div className='tab-column'>
									...
									>
										<option value='' disabled />
										<option value='GMT+5'>(GMT +5:00) Eastern Time</option>
										<option value='GMT+6'>(GMT +6:00) Central Time</option>
										<option value='GMT+7'>(GMT +7:00) Mountain Time</option>
										<option value='GMT+8'>(GMT +8:00) Pacific Time</option>
										<option value='GMT+9'>(GMT +9:00) Alaska Time</option>
										<option value='GMT+10'>(GMT +10:00) Hawaii Time</option>
									</Select>
								</div>
							</div>
