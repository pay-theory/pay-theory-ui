			...
			<div className='tab-contain'>
				...
				<RolesTab id={MENU_ITEMS.SYSTEM.tab} visibility='tab-visible'>
					...
					<Button
						...
						raised
						onClick={() => props.createRole(MENU_ITEMS.SYSTEM.label)}
					>
				...
				<RolesTab id={MENU_ITEMS.DISTRICT.tab} visibility='gone'>
					<FormHead text={`${MENU_ITEMS.DISTRICT.label} Level Roles`} />
					<InnerTable
					...
					<Button
						...
						raised
						onClick={() => props.createRole(MENU_ITEMS.DISTRICT.label)}
					>
						<i className='fal fa-plus-circle' />
						Create Role
					</Button>
				...
				<RolesTab id={MENU_ITEMS.PARTNER.tab} visibility='gone'>
					<FormHead text={`${MENU_ITEMS.PARTNER.label} Level Roles`} />
					<InnerTable
					...
					<Button
						...
						raised
						onClick={() => props.createRole(MENU_ITEMS.PARTNER.label)}
					>
						<i className='fal fa-plus-circle' />
						Create Role
					</Button>
